...
- Fix Priority: medium
- Components: J1
- Nets: USB_DN, VBUS, USB_DP, GND
- Metrics: {"required_power_nets": ["VIN", "VCC", "VBAT", "5V", "3V3", "VDD"], "required_ground_nets": ["GND", "GROUND", "PGND"], "observed_component_nets": ["USB_DN", "VBUS", "USB_DP", "GND"], "has_power": false, "has_ground": true}
...
- Components: U1
- Nets: USB_DN, USB_DP, GND, CLK
- Metrics: {"required_power_nets": ["VIN", "VCC", "VBAT", "5V", "3V3", "VDD"], "required_ground_nets": ["GND", "GROUND", "PGND"], "observed_component_nets": ["USB_DN", "USB_DP", "GND", "CLK"], "has_power": false, "has_ground": true}
