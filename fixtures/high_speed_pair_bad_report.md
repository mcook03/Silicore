...
- Components: U1
- Nets: USB_DN, GND, CLK, USB_DP
- Metrics: {"required_power_nets": ["VIN", "VCC", "VBAT", "5V", "3V3", "VDD"], "required_ground_nets": ["GND", "GROUND", "PGND"], "observed_component_nets": ["USB_DN", "GND", "CLK", "USB_DP"], "has_power": false, "has_ground": true}
