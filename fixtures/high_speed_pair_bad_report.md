...
- Fix Priority: medium
- Components: J1
- Nets: USB_DP, GND, VBUS, USB_DN
- Metrics: {"required_power_nets": ["VIN", "VCC", "VBAT", "5V", "3V3", "VDD"], "required_ground_nets": ["GND", "GROUND", "PGND"], "observed_component_nets": ["USB_DP", "GND", "VBUS", "USB_DN"], "has_power": false, "has_ground": true}
...
- Components: U1
- Nets: USB_DP, GND, CLK, USB_DN
- Metrics: {"required_power_nets": ["VIN", "VCC", "VBAT", "5V", "3V3", "VDD"], "required_ground_nets": ["GND", "GROUND", "PGND"], "observed_component_nets": ["USB_DP", "GND", "CLK", "USB_DN"], "has_power": false, "has_ground": true}
