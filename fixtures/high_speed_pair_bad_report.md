...
- Fix Priority: medium
- Components: J1
- Nets: USB_DP, VBUS, USB_DN, GND
- Metrics: {"required_power_nets": ["VIN", "VCC", "VBAT", "5V", "3V3", "VDD"], "required_ground_nets": ["GND", "GROUND", "PGND"], "observed_component_nets": ["USB_DP", "VBUS", "USB_DN", "GND"], "has_power": false, "has_ground": true}
...
- Components: U1
- Nets: USB_DP, USB_DN, GND, CLK
- Metrics: {"required_power_nets": ["VIN", "VCC", "VBAT", "5V", "3V3", "VDD"], "required_ground_nets": ["GND", "GROUND", "PGND"], "observed_component_nets": ["USB_DP", "USB_DN", "GND", "CLK"], "has_power": false, "has_ground": true}
