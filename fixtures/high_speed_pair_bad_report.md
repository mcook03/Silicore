...
- Components: U1
- Nets: GND, USB_DN, USB_DP, CLK
- Metrics: {"required_power_nets": ["VIN", "VCC", "VBAT", "5V", "3V3", "VDD"], "required_ground_nets": ["GND", "GROUND", "PGND"], "observed_component_nets": ["GND", "USB_DN", "USB_DP", "CLK"], "has_power": false, "has_ground": true}
