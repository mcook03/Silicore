...
- Fix Priority: medium
- Components: J1
- Nets: GND, VBUS, USB_DN, USB_DP
- Metrics: {"required_power_nets": ["VIN", "VCC", "VBAT", "5V", "3V3", "VDD"], "required_ground_nets": ["GND", "GROUND", "PGND"], "observed_component_nets": ["GND", "VBUS", "USB_DN", "USB_DP"], "has_power": false, "has_ground": true}
...
- Components: U1
- Nets: CLK, GND, USB_DN, USB_DP
- Metrics: {"required_power_nets": ["VIN", "VCC", "VBAT", "5V", "3V3", "VDD"], "required_ground_nets": ["GND", "GROUND", "PGND"], "observed_component_nets": ["CLK", "GND", "USB_DN", "USB_DP"], "has_power": false, "has_ground": true}
