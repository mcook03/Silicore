...
- Fix Priority: medium
- Components: J1
- Nets: VBUS, USB_DP, USB_DN, GND
- Metrics: {"required_power_nets": ["VIN", "VCC", "VBAT", "5V", "3V3", "VDD"], "required_ground_nets": ["GND", "GROUND", "PGND"], "observed_component_nets": ["VBUS", "USB_DP", "USB_DN", "GND"], "has_power": false, "has_ground": true}
