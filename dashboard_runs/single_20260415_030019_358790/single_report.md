...
- Fix Priority: medium
- Components: J1
- Nets: USB_DP, VBUS, GND, USB_DN
- Metrics: {"required_power_nets": ["VIN", "VCC", "VBAT", "5V", "3V3", "VDD"], "required_ground_nets": ["GND", "GROUND", "PGND"], "observed_component_nets": ["USB_DP", "VBUS", "GND", "USB_DN"], "has_power": false, "has_ground": true}
...
- Fix Priority: medium
- Components: U1
- Nets: USB_DP, CLK, GND, USB_DN
- Metrics: {"required_power_nets": ["VIN", "VCC", "VBAT", "5V", "3V3", "VDD"], "required_ground_nets": ["GND", "GROUND", "PGND"], "observed_component_nets": ["USB_DP", "CLK", "GND", "USB_DN"], "has_power": false, "has_ground": true}
