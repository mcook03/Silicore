...
2. **HIGH** — power_integrity — U3 may have poor power delivery because nearest regulator U1 is 37.22 units away
   - Recommendation: Move the regulator closer to the load or improve the power delivery path with lower-impedance routing.
3. **HIGH** — power_integrity — Power net VIN uses a narrow trace width (0.18)
...
- Components: U3
- Nets: GND, SENSOR_OUT
- Metrics: {"required_power_nets": ["VIN", "VCC", "VBAT", "5V", "3V3", "VDD"], "required_ground_nets": ["GND", "GROUND", "PGND"], "observed_component_nets": ["GND", "SENSOR_OUT"], "has_power": false, "has_ground": true}
