...
The strongest board is nc_drill.drl at 92.0 / 100, while the weakest board is bot_cu.ger at 82.0 / 100. The current score spread across the project is 10.0 points. The most recurring issue area across the project is assembly testability.
