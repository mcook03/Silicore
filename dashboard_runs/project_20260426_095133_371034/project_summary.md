...
The strongest board is thermal_hotspot_board.kicad_pcb at 20.0 / 100, while the weakest board is high_speed_pair_bad.kicad_pcb at 6.1 / 100. The current score spread across the project is 13.9 points. The most recurring issue area across the project is power integrity.
...
### #2 — high_speed_pair_bad.kicad_pcb
- Score: 6.1 / 100
- Total Risks: 44
- Total Penalty: 224.0
