...
- Components: U1
- Nets: USB_DP, GND, USB_DN, CLK
- Metrics: {"required_power_nets": ["VIN", "VCC", "VBAT", "5V", "3V3", "VDD"], "required_ground_nets": ["GND", "GROUND", "PGND"], "observed_component_nets": ["USB_DP", "GND", "USB_DN", "CLK"], "has_power": false, "has_ground": true}
