...
- Fix Priority: medium
- Components: J1
- Nets: GND, USB_DP, USB_DN, VBUS
- Metrics: {"required_power_nets": ["VIN", "VCC", "VBAT", "5V", "3V3", "VDD"], "required_ground_nets": ["GND", "GROUND", "PGND"], "observed_component_nets": ["GND", "USB_DP", "USB_DN", "VBUS"], "has_power": false, "has_ground": true}
...
- Components: U1
- Nets: GND, USB_DP, USB_DN, CLK
- Metrics: {"required_power_nets": ["VIN", "VCC", "VBAT", "5V", "3V3", "VDD"], "required_ground_nets": ["GND", "GROUND", "PGND"], "observed_component_nets": ["GND", "USB_DP", "USB_DN", "CLK"], "has_power": false, "has_ground": true}
