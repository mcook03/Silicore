...
DEFAULT_CONFIG = {
    ...
    "physics": {
        ...
        "impedance_tolerance_pct": 12.0,
        "reference_rise_time_ps": 500.0,
        "max_voltage_drop_mv": 75.0,
        "max_current_density_a_per_mm2": 12.0,
        "current_estimate_map": {
            "VBUS": 1.5,
            "VIN": 1.5,
            "BATT": 2.0,
            "PACK": 2.0,
    ...
    "rules": {
        ...
        "decoupling": {},
        "decoupling_strategy": {
            "local_distance_threshold": 4.0,
            "bulk_distance_threshold": 12.0,
            "min_local_caps": 1,
            "target_keywords": ["mcu", "cpu", "fpga", "soc", "adc", "dac", "sensor", "driver", "ic", "controller", "regulator", "pmic"],
            "capacitor_keywords": ["cap", "capacitor"],
            "bulk_keywords": ["10u", "22u", "47u", "100u", "bulk", "electrolytic", "tantalum"],
        },
        "power_distribution": {},
        "return_path": {},
        "signal_path": {},
